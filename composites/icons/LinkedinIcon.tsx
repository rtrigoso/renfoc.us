...
export default function LinkedinIcon() {
    return (
        <svg aria-hidden={true} role="img" width="1.25rem" height="1.25rem" strokeWidth="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color={ICON_COLOR}>
            ...
            <path d="M7 17V13.5V10" stroke={ICON_COLOR} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
            <path d="M11 17V13.75M11 10V13.75M11 13.75C11 10 17 10 17 13.75V17" stroke={ICON_COLOR} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
            <path d="M7 7.01L7.01 6.99889" stroke={ICON_COLOR} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
        </svg>
    );
}
